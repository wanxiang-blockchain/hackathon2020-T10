...
#define	    CONFIG_LINE_MAX_CHAR			128	//一行最大字符数
#define	    CONFIG_ROW_MAX_CHAR			    95	//键值最大字符数:128-32-1
#define	    CONFIG_SECTION_MAX_CHAR			16	//段名最大字符数
#define	    CONFIG_KEY_MAX_CHAR			    32	//关键字名最大字符数
#define	    CONFIG_MAX_LINE			        32	//各段最大键值数
#define	    CONFIG_MAX_SECTION			    32	//最大段数
